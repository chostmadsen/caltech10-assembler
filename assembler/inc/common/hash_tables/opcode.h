...
static  const   hash_entry  opcode_table[OPCODE_TBL_S]  =   {                   // opcode hash table
    ...
    [148]   =   { 0x39c843a770392e94, "call",  4, { .tok=tok_call,  .grp=subrout_st_t,     .instr=0xe000 } },
    [ 86]   =   { 0xde4ea564f5a80a56, "rts",   3, { .tok=tok_rts,   .grp=subrout_st_t,     .instr=0x1f00 } },
    [ 72]   =   { 0x49687a4847e31e48, "popf",  4, { .tok=tok_popf,  .grp=subrout_st_t,     .instr=0x0200 } },
    [ 74]   =   { 0x4cda702925cb204a, "pushf", 5, { .tok=tok_pushf, .grp=subrout_st_t,     .instr=0x0e00 } },
