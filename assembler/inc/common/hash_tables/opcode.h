 ...
 * AUTO-GENERATED (seed 0) - DO NOT MANUALLY MODIFY; see perfhash/README.md for usage.
 */
...
static  const   hash_entry  opcode_table[OPCODE_TBL_S]  =   {                   // opcode hash table
    ...
    [250]   =   { 0xd92dcd1b159bd8fa, "call",  4, { .tok=tok_call,  .grp=subrout_st_adrs_t, .instr=0xe000 } },
    [109]   =   { 0xf16257e510f80f6d, "rts",   3, { .tok=tok_rts,   .grp=subrout_st_lone_t, .instr=0x1f00 } },
    [134]   =   { 0x0f37ba8cd606f586, "popf",  4, { .tok=tok_popf,  .grp=subrout_st_lone_t, .instr=0x0200 } },
    [ 69]   =   { 0x1a3e8d9c7d25bb45, "pushf", 5, { .tok=tok_pushf, .grp=subrout_st_lone_t, .instr=0x0e00 } },
...
static tok_itm opcode_hash_lu(const char *const str, const size_t n) {          // opcode hash table lookup
    ...
    if (n > OPCODE_MAX_STR)         return  (tok_itm){ .tok=0, .grp=0 };
